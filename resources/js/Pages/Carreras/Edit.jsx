    ...
    return (
        <AppLayout>
            <div className="mx-auto max-w-xl">
                <h1 className="mb-6 text-2xl font-bold tracking-tight text-gray-900">Editar carrera</h1>
                ...
                <form onSubmit={enviar} className="space-y-6 rounded-xl border border-gray-200/80 bg-white p-6 shadow-sm">
                    ...
                    <FormActions onCancel={route('carreras.index')} processing={processing} label="Guardar cambios" />
                </form>
            </div>
        </AppLayout>
    );
